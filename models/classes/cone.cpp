...
using namespace std;
cone::cone(ponto centroBase, ponto vertice, float radius, tupla Kd, tupla Ke, tupla Ka, float M, bool temBase, bool temAnel) : centroBase(centroBase), vertice(vertice), radius(radius), objeto(Kd, Ke, Ka, M), temBase(temBase), temAnel(temAnel){colisaoBase = false;};
